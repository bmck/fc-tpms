...
void autotest_dotprod_cccf_struct_lengths()
{
    ...
    if (liquid_autotest_verbose) {
        LOGI("  dotprod-cccf-32 : %12.8f + j%12.8f (expected %12.8f + j%12.8f)\n",
    ...
    dotprod_cccf_destroy(dp);
    if (liquid_autotest_verbose) {
        LOGI("  dotprod-cccf-33 : %12.8f + j%12.8f (expected %12.8f + j%12.8f)\n",
    ...
    dotprod_cccf_destroy(dp);
    if (liquid_autotest_verbose) {
        LOGI("  dotprod-cccf-34 : %12.8f + j%12.8f (expected %12.8f + j%12.8f)\n",
    ...
    dotprod_cccf_destroy(dp);
    if (liquid_autotest_verbose) {
        LOGI("  dotprod-cccf-35 : %12.8f + j%12.8f (expected %12.8f + j%12.8f)\n",
...
void runtest_dotprod_cccf(unsigned int _n)
{
    ...
    // print results
    if (liquid_autotest_verbose) {
        LOGI("  dotprod-cccf-%-4u : %12.8f + j%12.8f (expected %12.8f + j%12.8f)\n",
