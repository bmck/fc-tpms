                            ...
                            int          _flags)
{
    ...
    default:
        LOGE("error: fft_create_plan(), unknown/invalid fft method\n");
        exit(1);
    }
...
void FFT(_destroy_plan)(FFT(plan) _q)
{
    ...
    case LIQUID_FFT_BACKWARD:
        ...
        case LIQUID_FFT_METHOD_UNKNOWN:
        default:
            LOGE("error: fft_destroy_plan(), unknown/invalid fft method\n");
            exit(1);
        }
        break;
    ...
    default:
        LOGE("error: fft_destroy_plan(), unknown/invalid fft type\n");
        exit(1);
    }
}
...
void FFT(_print_plan)(FFT(plan) _q)
{
    ...
    case LIQUID_FFT_BACKWARD:
        LOGI("fft plan [%s], n=%u, ",
                ...
                _q->nfft);
        switch (_q->method) {
        case LIQUID_FFT_METHOD_DFT:         LOGI("DFT\n");                break;
        case LIQUID_FFT_METHOD_RADIX2:      LOGI("Radix-2\n");            break;
        case LIQUID_FFT_METHOD_MIXED_RADIX: LOGI("Cooley-Tukey\n");       break;
        case LIQUID_FFT_METHOD_RADER:       LOGI("Rader (Type I)\n");     break;
        case LIQUID_FFT_METHOD_RADER2:      LOGI("Rader (Type II)\n");    break;
        case LIQUID_FFT_METHOD_UNKNOWN:
        default:
            LOGE("error: fft_destroy_plan(), unknown/invalid fft method\n");
            exit(1);
    ...
    case LIQUID_FFT_UNKNOWN:
    default:
        LOGE("error: fft_print_plan(), unknown/invalid fft type\n");
        exit(1);
    }
}
                                ...
                                unsigned int _level)
{
    ...
    case LIQUID_FFT_METHOD_MIXED_RADIX:
        ...
        LOGI("Cooley-Tukey mixed radix, Q=%u, P=%u\n",
    ...
    case LIQUID_FFT_METHOD_RADER:
        LOGI("Rader (Type-II), nfft-prime=%u\n", _q->nfft-1);
    ...
    case LIQUID_FFT_METHOD_UNKNOWN:     LOGI("(unknown)\n");      break;
