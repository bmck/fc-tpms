...
void autotest_matrixf_aug()
{
    ...
    if (liquid_autotest_verbose) {
        LOGI("augment:\n");
        LOGI("  x: ");        matrixf_print(matrixf_data_aug_x,5,4);
        LOGI("  y: ");        matrixf_print(matrixf_data_aug_y,5,3);
        LOGI("  expected: "); matrixf_print(matrixf_data_aug_z,5,7);
        LOGI("  z: ");        matrixf_print(z,5,3);
    }
...
void autotest_matrixf_cgsolve()
{
    ...
    if (liquid_autotest_verbose) {
        LOGI("cgsolve:\n");
        LOGI("  A: ");        matrixf_print(matrixf_data_cgsolve_A, 8, 8);
        LOGI("  b: ");        matrixf_print(matrixf_data_cgsolve_b, 8, 1);
        LOGI("  expected: "); matrixf_print(matrixf_data_cgsolve_x, 8, 1);
        LOGI("  x: ");        matrixf_print(x,                      8, 1);
    }
...
void autotest_matrixf_chol()
{
    ...
    if (liquid_autotest_verbose) {
        LOGI("chol:\n");
        LOGI("  A: ");        matrixf_print(matrixf_data_chol_A, 4, 4);
        LOGI("  expected: "); matrixf_print(matrixf_data_chol_L, 4, 4);
        LOGI("  L: ");        matrixf_print(L,                   4, 4);
    }
...
void autotest_matrixf_gramschmidt()
{
    ...
    if (liquid_autotest_verbose) {
        LOGI("gramschmidt:\n");
        LOGI("  A: ");        matrixf_print(matrixf_data_gramschmidt_A, 4, 3);
        LOGI("  expected: "); matrixf_print(matrixf_data_gramschmidt_V, 4, 3);
        LOGI("  V: ");        matrixf_print(V,                          4, 3);
    }
...
void autotest_matrixf_inv()
{
    ...
    if (liquid_autotest_verbose) {
        LOGI("inv:\n");
        LOGI("  x: ");        matrixf_print(matrixf_data_inv_x, 5, 5);
        LOGI("  expected: "); matrixf_print(matrixf_data_inv_y, 5, 5);
        LOGI("  y: ");        matrixf_print(y,                  5, 5);
    }
...
void autotest_matrixf_linsolve()
{
    ...
    if (liquid_autotest_verbose) {
        LOGI("linsolve:\n");
        LOGI("  A: ");        matrixf_print(matrixf_data_linsolve_A, 5, 5);
        LOGI("  b: ");        matrixf_print(matrixf_data_linsolve_b, 5, 1);
        LOGI("  expected: "); matrixf_print(matrixf_data_linsolve_x, 5, 1);
        LOGI("  x: ");        matrixf_print(x,                       5, 1);
    }
...
void autotest_matrixf_ludecomp_crout()
{
    ...
    if (liquid_autotest_verbose) {
        LOGI("ludecomp_crout:\n");
        LOGI("  A: ");        matrixf_print(matrixf_data_ludecomp_A,8,8);
        LOGI("  L: ");        matrixf_print(L,                      8,8);
        LOGI("  U: ");        matrixf_print(U,                      8,8);
        LOGI("  LU: ");       matrixf_print(LU_test,                8,8);
    }
...
void autotest_matrixf_mul()
{
    ...
    if (liquid_autotest_verbose) {
        LOGI("multiplication:\n");
        LOGI("  x: ");        matrixf_print(matrixf_data_mul_x,5,4);
        LOGI("  y: ");        matrixf_print(matrixf_data_mul_y,4,3);
        LOGI("  expected: "); matrixf_print(matrixf_data_mul_z,5,3);
        LOGI("  z: ");        matrixf_print(z,5,3);
    }
...
void autotest_matrixf_qrdecomp()
{
    ...
    if (liquid_autotest_verbose) {
        LOGI("qrdecomp_gramschmidt:\n");
        LOGI("  A: ");          matrixf_print(matrixf_data_qrdecomp_A,4,4);
        LOGI("  Q: ");          matrixf_print(Q,                      4,4);
        LOGI("  R: ");          matrixf_print(R,                      4,4);
        LOGI("  Q expected: "); matrixf_print(matrixf_data_qrdecomp_Q,4,4);
        LOGI("  R expected: "); matrixf_print(matrixf_data_qrdecomp_R,4,4);
        LOGI("  QR: ");         matrixf_print(QR_test,                4,4);
        LOGI("  QQ: ");         matrixf_print(QQT_test,               4,4);
    }
...
void autotest_matrixf_transmul()
{
    ...
    if (liquid_autotest_verbose) {
        LOGI("transmul:\n");
        LOGI("  x: ");            matrixf_print(matrixf_data_transmul_x,  5,4);
        LOGI("\n");
        LOGI("  xxT: ");          matrixf_print(xxT,                      5,5);
        LOGI("  xxT expected: "); matrixf_print(matrixf_data_transmul_xxT,5,5);
        LOGI("\n");
        LOGI("  xxH: ");          matrixf_print(xxH,                      5,5);
        LOGI("  xxH expected: "); matrixf_print(matrixf_data_transmul_xxH,5,5);
        LOGI("\n");
        LOGI("  xTx: ");          matrixf_print(xTx,                      4,4);
        LOGI("  xTx expected: "); matrixf_print(matrixf_data_transmul_xTx,4,4);
        LOGI("\n");
        LOGI("  xHx: ");          matrixf_print(xHx,                      4,4);
        LOGI("  xHx expected: "); matrixf_print(matrixf_data_transmul_xHx,4,4);
        LOGI("\n");
    }
