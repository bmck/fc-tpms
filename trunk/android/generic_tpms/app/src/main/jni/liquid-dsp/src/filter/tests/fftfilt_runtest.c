                       ...
                       unsigned int _y_len)
{
    ...
    if (liquid_autotest_verbose) {
        LOGI("fftfilt_rrrf_test(), h_len: %3u, x_len: %3u (%3u blocks @ %3u samples, %3u remaining)\n",
                       ...
                       unsigned int    _y_len)
{
    ...
    unsigned int num_blocks = d.quot + (d.rem ? 1 : 0);
    if (liquid_autotest_verbose) {
        LOGI("fftfilt_crcf_test(), h_len: %3u, x_len: %3u (%3u blocks @ %3u samples, %3u remaining)\n",
                _h_len, _x_len, n, d.quot, d.rem);
    }
                       ...
                       unsigned int    _y_len)
{
    ...
    unsigned int num_blocks = d.quot + (d.rem ? 1 : 0);
    if (liquid_autotest_verbose) {
        LOGI("fftfilt_cccf_test(), h_len: %3u, x_len: %3u (%3u blocks @ %3u samples, %3u remaining)\n",
                _h_len, _x_len, n, d.quot, d.rem);
    }
