...
void IIRFILTSOS(_print)(IIRFILTSOS() _q)
{
    ...
    LOGI("  b : ");
    PRINTVAL_TC(_q->b[0],%12.8f); LOGI(",");
    PRINTVAL_TC(_q->b[1],%12.8f); LOGI(",");
    PRINTVAL_TC(_q->b[2],%12.8f); LOGI("\n");

    LOGI("  a : ");
    PRINTVAL_TC(_q->a[0],%12.8f); LOGI(",");
    PRINTVAL_TC(_q->a[1],%12.8f); LOGI(",");
    PRINTVAL_TC(_q->a[2],%12.8f); LOGI("\n");
}
