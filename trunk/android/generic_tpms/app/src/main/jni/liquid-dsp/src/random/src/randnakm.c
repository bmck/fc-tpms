                ...
                float _omega)
{
    // validate input
    if (_m < 0.5f) {
        LOGE("error: randnakmf(), m cannot be less than 0.5\n");
        exit(1);
    } else if (_omega <= 0.0f) {
        LOGE("error: randnakmf(), omega must be greater than zero\n");
        exit(1);
    }
                    ...
                    float _omega)
{
    // validate input
    if (_m < 0.5f) {
        LOGE("error: randnakmf_pdf(), m cannot be less than 0.5\n");
        exit(1);
    } else if (_omega <= 0.0f) {
        LOGE("error: randnakmf_pdf(), omega must be greater than zero\n");
        exit(1);
    }
                    ...
                    float _omega)
{
    // validate input
    if (_m < 0.5f) {
        LOGE("error: randnakmf_cdf(), m cannot be less than 0.5\n");
        exit(1);
    } else if (_omega <= 0.0f) {
        LOGE("error: randnakmf_cdf(), omega must be greater than zero\n");
        exit(1);
    }
