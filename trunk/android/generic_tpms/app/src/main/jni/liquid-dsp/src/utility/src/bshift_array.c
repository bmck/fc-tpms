                    ...
                    unsigned int _b)
{
    // validate input
    if (_b >= 8) {
        LOGE("error: liquid_lbshift(), shift amount must be in [0,7]\n");
        exit(1);
    }
                    ...
                    unsigned int _b)
{
    // validate input
    if (_b >= 8) {
        LOGE("error: liquid_rbshift(), shift amount must be in [0,7]\n");
        exit(1);
    }
                        ...
                        unsigned int _b)
{
    // validate input
    if (_b >= 8) {
        LOGE("error: liquid_lbcircshift(), shift amount must be in [0,7]\n");
        exit(1);
    }
...
#if 0
    LOGI("num_bits = %1u, shift_0 = %1u, shift_1 = %1u mask_0=%.2x, mask_1=%.2x\n",
