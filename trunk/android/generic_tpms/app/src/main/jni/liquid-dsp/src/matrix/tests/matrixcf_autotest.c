...
void autotest_matrixcf_aug()
{
    ...
    if (liquid_autotest_verbose) {
        LOGI("augment:\n");
        LOGI("  x: ");        matrixcf_print(matrixcf_data_aug_x, 5, 4);
        LOGI("  y: ");        matrixcf_print(matrixcf_data_aug_y, 5, 3);
        LOGI("  expected: "); matrixcf_print(matrixcf_data_aug_z, 5, 7);
        LOGI("  z: ");        matrixcf_print(z,5,3);
    }
...
void autotest_matrixcf_chol()
{
    ...
    if (liquid_autotest_verbose) {
        LOGI("chol:\n");
        LOGI("  A: ");        matrixcf_print(matrixcf_data_chol_A, 4, 4);
        LOGI("  expected: "); matrixcf_print(matrixcf_data_chol_L, 4, 4);
        LOGI("  L: ");        matrixcf_print(L,                    4, 4);
    }
...
void autotest_matrixcf_inv()
{
    ...
    if (liquid_autotest_verbose) {
        LOGI("inv:\n");
        LOGI("  x: ");        matrixcf_print(matrixcf_data_inv_x, 5, 5);
        LOGI("  expected: "); matrixcf_print(matrixcf_data_inv_y, 5, 5);
        LOGI("  y: ");        matrixcf_print(y,                   5, 5);
    }
...
void autotest_matrixcf_linsolve()
{
    ...
    if (liquid_autotest_verbose) {
        LOGI("linsolve:\n");
        LOGI("  A: ");        matrixcf_print(matrixcf_data_linsolve_A, 5, 5);
        LOGI("  b: ");        matrixcf_print(matrixcf_data_linsolve_b, 5, 1);
        LOGI("  expected: "); matrixcf_print(matrixcf_data_linsolve_x, 5, 1);
        LOGI("  x: ");        matrixcf_print(x,                        5, 1);
    }
...
void autotest_matrixcf_ludecomp_crout()
{
    ...
    if (liquid_autotest_verbose) {
        LOGI("ludecomp_crout:\n");
        LOGI("  A: ");  matrixcf_print(matrixcf_data_ludecomp_A, 8, 8);
        LOGI("  L: ");  matrixcf_print(L,                        8, 8);
        LOGI("  U: ");  matrixcf_print(U,                        8, 8);
        LOGI("  LU: "); matrixcf_print(LU_test,                  8, 8);
    }
...
void autotest_matrixcf_mul()
{
    ...
    if (liquid_autotest_verbose) {
        LOGI("multiplication:\n");
        LOGI("  x: ");        matrixcf_print(matrixcf_data_mul_x,5,4);
        LOGI("  y: ");        matrixcf_print(matrixcf_data_mul_y,4,3);
        LOGI("  expected: "); matrixcf_print(matrixcf_data_mul_z,5,3);
        LOGI("  z: ");        matrixcf_print(z,5,3);
    }
...
void autotest_matrixcf_qrdecomp()
{
    ...
    if (liquid_autotest_verbose) {
        ...
        LOGI("  A: ");          matrixcf_print(matrixcf_data_qrdecomp_A, 4, 4);
        LOGI("  Q: ");          matrixcf_print(Q,                        4, 4);
        LOGI("  R: ");          matrixcf_print(R,                        4, 4);
        LOGI("  Q expected: "); matrixcf_print(matrixcf_data_qrdecomp_Q, 4, 4);
        LOGI("  R expected: "); matrixcf_print(matrixcf_data_qrdecomp_R, 4, 4);
        LOGI("  QR: ");         matrixcf_print(QR_test,                  4, 4);
        LOGI("  QQ: ");         matrixcf_print(QQT_test,                 4, 4);
    }
...
void autotest_matrixcf_transmul()
{
    ...
    if (liquid_autotest_verbose) {
        LOGI("transmul:\n");
        LOGI("  x: ");            matrixcf_print(matrixcf_data_transmul_x,  5,4);
        LOGI("\n");
        LOGI("  xxT: ");          matrixcf_print(xxT,                      5,5);
        LOGI("  xxT expected: "); matrixcf_print(matrixcf_data_transmul_xxT,5,5);
        LOGI("\n");
        LOGI("  xxH: ");          matrixcf_print(xxH,                      5,5);
        LOGI("  xxH expected: "); matrixcf_print(matrixcf_data_transmul_xxH,5,5);
        LOGI("\n");
        LOGI("  xTx: ");          matrixcf_print(xTx,                      4,4);
        LOGI("  xTx expected: "); matrixcf_print(matrixcf_data_transmul_xTx,4,4);
        LOGI("\n");
        LOGI("  xHx: ");          matrixcf_print(xHx,                      4,4);
        LOGI("  xHx expected: "); matrixcf_print(matrixcf_data_transmul_xHx,4,4);
        LOGI("\n");
    }
