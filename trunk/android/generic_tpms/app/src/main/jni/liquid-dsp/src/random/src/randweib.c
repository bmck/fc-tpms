                ...
                float _gamma)
{
    // validate input
    if (_alpha <= 0) {
        LOGE("error: randweibf(), alpha must be greater than zero\n");
        return 0.0f;
    } else if (_beta <= 0) {
        LOGE("error: randweibf(), beta must be greater than zero\n");
        return 0.0f;
    }
                    ...
                    float _gamma)
{
    ...
    // validate input
    if (_alpha <= 0) {
        LOGE("error: randweibf_pdf(), alpha must be greater than zero\n");
        return 0.0f;
    } else if (_beta <= 0) {
        LOGE("error: randweibf_pdf(), beta must be greater than zero\n");
        return 0.0f;
    }
#endif
                    ...
                    float _gamma)
{
    ...
    // validate input
    if (_alpha <= 0) {
        LOGE("error: randweibf_cdf(), alpha must be greater than zero\n");
        return 0.0f;
    } else if (_beta <= 0) {
        LOGE("error: randweibf_cdf(), beta must be greater than zero\n");
        return 0.0f;
    }
#endif
