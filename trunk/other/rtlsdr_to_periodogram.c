...
// gcc -o rtlsdr_to_periodogram rtlsdr_to_periodogram.c /Users/bmck/src/liquid-dsp/libliquid.a -I/Users/bmck/src/liquid-dsp/include
...
int main(int argc, char*argv[])
{
    ...
    char       filename_input[256] = "/tmp/fc-abridged.bin";
    ...
    float fsk_freq_offset = -102.40 / Fs;
    unsigned int k = 40;    // samples per symbol
    //unsigned int p = 1;     // starting sample
    ...
    do
    {
        ...
        float complex x = ((float)(xi) - 127.0f) +
