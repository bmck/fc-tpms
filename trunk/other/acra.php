<?php
//CONFIG
$shared_secret = "fc_w4r4w4Rq";
$recipient = "bmck@fleetcents.com";
  ...
  <div class="row-fluid">
    <div class="span10 offset1 box">
      <center>
        ...
        <h2><?="{$_REQUEST['PACKAGE_NAME']} {$_REQUEST['APP_VERSION_NAME']} on {$_REQUEST['PHONE_MODEL']} ({$_REQUEST['ANDROID_VERSION']})"?></h2>
      </center>
        <table class="table" style="width:100%;" cellpadding="0" cellspacing="0" border="0" align="center">
          <?php foreach($_REQUEST as $k=>$v) {
            ...
            <tr class="<?=stristr($k, "trace") ? "error":""?>">
                ...
                <td valign="top"><pre class="prettyprint linenums"><?=$v?></pre></td>
            </tr>
            <?php } ?>
        </table>
      </div>
